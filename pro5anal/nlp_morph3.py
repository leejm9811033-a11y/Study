...
from collections import Counter     # 단어 수를 카운팅 하는 라이브러리
import pytagcloud
...
# print(taglist) # {'color': (211, 93, 129), 'size': 75, 'tag': '시기'} ....
...
# fontname='Korean' 폰트 넣어야한다.
# C:\Users\acorn\anaconda3\envs\myproject\Lib\site-packages\pytagcloud\fonts
