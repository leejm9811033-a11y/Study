...
# 정규성, 등분산성
x1 = np.array(data[data.ta_gubun == 0].AMT)     # 추움 그룹
...
print()
print(stats.levene(x1, x2, x3).pvalue)      #  만족 X
...
# statistic=99.1908012, pvalue=2.3607371e-34
# 해석 : pvalue=2.360737101 < alpha 0.05 이므로 귀무 기각
# 어느 음식점의 매출 데이터는 온도에 따라 매출액 평균에 차이가 있다.

print()
# 정규성 깨지면 stats.kruskal() 사용, 등분산성이 깨지면 welch ANOVA
# stats.kruskal()
