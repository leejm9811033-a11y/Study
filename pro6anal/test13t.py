...
follow_up = [62.2, 64.6, 70.4, 62.6, 80.1, 73.2, 58.2, 71.0, 101.0]
...
print(result)
# statistic=3.6857481975160207, pvalue=0.0061678556634532, df=8
# 해석 : pvalue 0.0061678556634532 < alpha 0.05이므로 귀무가설 기각
# 복부 수술 전 몸무게와 복부 수술 후 몸무게의 변화는 있다. 라는 의견
