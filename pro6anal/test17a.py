...
# 관측자수 PR(>F) 6.497055e-03(0.006470) < 0.05 : 귀무기각. 관측자 수와 태아의 머리둘레 평균은 차이가 있다.(유의함)
...
# 주효과 가설
# 귀무 : poison 종류와 응급처치 방법은 관련이 없다.
# 대립 : poison 종류와 응급처치 방법은 관련이 있다.
# 귀무 : treat(응급처치) 방법과 독 퍼짐 시간의 평균 차이가 없다.
# 대립 : treat(응급처치) 방법과 독 퍼짐 시간의 평균 차이가 있다.
# 교호작용 가설
...
# 관측자수 PR(>F) 3.777331e-06 < 0.05 : 귀무기각.
# 상호작용 PR(>F) 1.122506e-01 > 0.05 : 귀무채택. 태아수와 관측자 수는 관련이 없다.
# 해석 :
# poison 종류와 응급처치 방법은 관련이 있다.
# treat(응급처치) 방법과 독 퍼짐 시간의 평균 차이가 있다.
# 주효과는 있음, 상호작용은 없음
