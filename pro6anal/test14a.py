...
print(result)
#                   df(자유도)    sum_sq(제곱합)       mean_sq(제곱 평균)          F(F값)      PR(>F)(p값)
...
print('f_value : ', f_value)    # f_value :  0.1222284760031028
print('p_value : ', p_value)    # p_value :  0.727596911313686
...
#      1      3   1.4904 0.9363 -8.8183  11.799  False : 유의미한 차이가 없으면 True
