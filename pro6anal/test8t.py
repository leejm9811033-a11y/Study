...
# wilcox_result :  statistic=74.0, pvalue=0.3977762  
# alpha 0.05 < pvalue=0.3977762  이므로 귀무가설 채택

print()
result = stats.ttest_1samp(data['국어'], popmean=80)
print("result : ", result)
# TtestResult(statistic=-1.332180166, pvalue=0.1985605)
...
# 비모수검정 (wilconxon) 결과도 동일하므로 ttest_1samp 결과를 신뢰할 수 있다" 라고 명시한다.
...
# result : statistic=2.23318766, pvalue=0.03926844, df=17
# 해석1 (p값) : alpha 0.05 > pvalue=0.03926844 이므로 귀무가설 기각
...
# 해석3 (p값) : alpha 0.05 > pvalue=0.034233 이므로 귀무가설 기각
