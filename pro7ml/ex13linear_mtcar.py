...
print('RMSE : ', np.sqrt(mean_squared_error(y, pred)))  # 3.740297086
print('r2_score : ', r2_score(y, pred))                 # 0.602437341
# r2_score 하나만 보고 모델 판단 X(이상치에 민감, 변수가 많으면 증가...), 설명력만 봄
# 모델 성능은 r2_score와 MSE 또는 RMSE를 사용하도록 한다.
