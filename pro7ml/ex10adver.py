...
print(f"coeffiecnt:{lm.params}, p-value:{lm.pvalues}, r-squared:{lm.rsquared}")
# print(0.782224 ** 2)
print(lm.summary())
...
fitted = lm.predict(advdf)      # lm.predict(advdf)
...
from statsmodels.stats.diagnostic import linear_reset   # 선형성 확인 모듈 도구
...
print("등분산성 검정 : 모든 x값에서 오차의 퍼짐에 유의해야 한다")
...
print()
# 참고 : Cook's distance - 특정 테이터가 회귀모델에 얼마나 영향을 주는지 확인
