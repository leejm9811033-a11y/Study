...
# 값의 범위는 0 ~ 4 이고 2이면 정상 (자기상관 없음). < 2이면 양의 자기상관,  > 2 음의 자기상관
...
# # 시각화
# sns.barplot(x="변수", y="vif_value", data=)
# plt.title("VIF")
# plt.show()
...
# new_df = pd.DataFrame({"Income":[35, 64], "Advertising":[6, 3],\
