...
kmeansModel.fit(train_x)    # label이 중요하지 않음
print(kmeansModel.labels_)  # 군집 라벨 출력
print('예측군집값 : ', kmeansModel.labels_[:10])    # [1 1 2 2 2 1 1 2 2 0]
# print('실제값 : ', train_y[:10])                   # [0 0 2 1 1 0 0 1 2 2]
...
print(f'KMeans : 새로운 값 군집은 {clu_pred}로 분류됨')
...
np_arr[np_arr == 3] = 1     # 군집 5을 1(verginicar)로 변경
print('np_arr : ', np_arr)
