...
# pipline(steps=[('pca', PCA(n_components=100, random_state=0, whiten=True)))])
# ('scv', SVC(C=1, random_state=1))
...
#      Colin Powell       0.60      0.69      0.65        59
#   Donald Rumsfeld       0.67      0.40      0.50        30
#     George W Bush       0.67      0.89      0.76       133
# Gerhard Schroeder       0.40      0.22      0.29        27
#       Hugo Chavez       0.44      0.22      0.30        18
# Junichiro Koizumi       1.00      0.73      0.85        15
#        Tony Blair       0.54      0.56      0.55        36
#          accuracy                           0.63       337
#         macro avg       0.54      0.46      0.49       337
#      weighted avg       0.59      0.63      0.59       337

print('분류 결과를 시각화 하기')
# x_test[0] 번째 1개만 보기
# plt.subplots(1, 1)
# plt.imshow(x_test[0].reshape(62, 47), cmap='bone')   # 1차원을 2차원으로 변환
# plt.show()
...
# print('img_np : ', img_np)
img_np = img_np /255# 정규화 (학습 데이터와 맞춰줘야 함)
print('img_np : ', img_np)  
